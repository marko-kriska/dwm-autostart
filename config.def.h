...
static const char *fonts[]          = { "JetBrainsMono Nerd Font:weight=medium:size=10" };
static const char dmenufont[]       = "JetBrainsMono Nerd Font:weight=medium:size=10";
...
static const char *miccmd[]     = { "pactl", "set-source-mute", "@DEFAULT_SOURCE@", "toggle", NULL };
static const char *brightup[]   = { "brightnessctl", "set", "+10", NULL };
static const char *brightdown[] = { "brightnessctl", "set", "10-", NULL };
static const char *slock[]      = { "slock", "systemctl", "suspend", "-i", NULL };
